   ...
   function showFormData() {  // GetelemenByid berguna untuk mendeteksi kelas mana yang mempunyai id lalu di panggil 
      ...
      alert(formData); // Berguna untuk saat user sudah mengisi maka akan kembali ke menu utama menggunaan 
